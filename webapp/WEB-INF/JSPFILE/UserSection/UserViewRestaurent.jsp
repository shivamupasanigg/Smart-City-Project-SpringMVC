...
<!-- CSS File-->
<link rel="stylesheet"
	href="<c:url value='/resources/UserCSSFile/UserViewRestaurent.css' />">
...
<!-- JQUERY File Link -->
<script
	src="<c:url value='/resources/UserJsFile/UserViewRestaurentJs.js' />"></script>
		...
		<div class="main box-show">
			...
			<div class="details">
				<div class="swiper mySwiper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${RestaurentImageone}" alt="">
						</div>
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${RestaurentImagetwo}" alt="">
						</div>
					</div>
				...
				<div class="details">
					<table>
						<tr>
							<th class="heading">Restaurant Name :</th>
							<td class="input">${ViewRestaurent.restaurant_name}</td>
						</tr>
						<tr>
							<th class="heading">Restaurant Address :</th>
							<td class="input">${ViewRestaurent.restaurant_address}</td>
						</tr>
						<tr>
							<th class="heading">Restaurant Dishes :</th>
							<td class="input">${ViewRestaurent.restaurant_dishes}</td>
						</tr>
						<tr>
							<th class="heading">Restaurant Phone :</th>
							<td class="input">${ViewRestaurent.restaurant_phone}</td>
						</tr>
						<tr>
							<th class="heading">Morning Time :</th>
							<td class="input">${ViewRestaurent.restaurant_amtime}&nbsp;<span>AM</span></td>
						</tr>
						<tr>
							<th class="heading">Evening Time :</th>
							<td class="input">${ViewRestaurent.restaurant_pmtime}&nbsp;<span>PM</span></td>
						</tr>
					</table>
