...
<!-- CSS File-->
<link rel="stylesheet"
	href="<c:url value='/resources/UserCSSFile/UserViewHospital.css' />">
...
<!-- JQUERY File Link -->
<script
	src="<c:url value='/resources/UserJsFile/UserViewHospitalJs.js' />"></script>
				...
				<div class="swiper mySwiper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${HospitalImageone}" alt="">
						</div>
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${HospitalImagetwo}" alt="">
						</div>
					</div>
				...
				<div class="details">
					<table>
						<tr>
							...
							<td class="input">${ViewHospital.hospital_name}</td>
						</tr>
						<tr>
							<th class="heading">Hospital Address :</th>
							<td class="input">${ViewHospital.hospital_address}</td>
						</tr>
						<tr>
							<th class="heading">Hospital Facility :</th>
							<td class="input">${ViewHospital.hospital_facility}</td>
						</tr>
						<tr>
							<th class="heading">Hospital Phone :</th>
							<td class="input">${ViewHospital.hospital_phone}</td>
						</tr>
						<tr>
							<th class="heading">Hospital Time :</th>
							<td class="input">${ViewHospital.hospital_time}</td>
						</tr>
					</table>
