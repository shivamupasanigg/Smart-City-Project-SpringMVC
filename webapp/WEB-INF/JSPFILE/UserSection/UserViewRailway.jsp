...
<!-- CSS File-->
<link rel="stylesheet"
	href="<c:url value='/resources/UserCSSFile/UserViewRailway.css' />">
...
<!-- JQUERY File Link -->
<script
	src="<c:url value='/resources/UserJsFile/UserViewRailwayJs.js' />"></script>

<title>View Railway Station</title>
</head>
<body>
	<!-- Load header -->
		...
		<div class="main box-show">
			...
			<div class="details">
				<div class="swiper mySwiper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${RailwayImageone}" alt="">
						</div>
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${RailwayImagetwo}" alt="">
						</div>
					</div>
				...
				<div class="details">
					<table>
						<tr>
							<th class="heading">Railway Station Name :</th>
							<td class="input">${viewRailway.railway_Station_name}</td>
						</tr>
						<tr>
							<th class="heading">Railway Station Address :</th>
							<td class="input">${viewRailway.railway_Station_address}</td>
						</tr>
					</table>
					
					<h1>Railway Station Map</h1>
					<hr>
					<br>
