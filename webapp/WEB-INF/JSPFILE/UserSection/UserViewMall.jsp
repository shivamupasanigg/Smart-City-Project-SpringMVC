...
<!-- CSS File-->
<link rel="stylesheet"
	href="<c:url value='/resources/UserCSSFile/UserViewMall.css' />">
...
<!-- JQUERY File Link -->
<script
	src="<c:url value='/resources/UserJsFile/UserViewMallJs.js' />"></script>
		...
		<div class="main box-show">
			...
			<div class="details">
				<div class="swiper mySwiper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${MallImageone}" alt="">
						</div>
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${MallImagetwo}" alt="">
						</div>
					</div>
				...
				<div class="details">
					<table>
						<tr>
							<th class="heading">Mall Name :</th>
							<td class="input">${malls.mall_name}</td>
						</tr>
						<tr>
							<th class="heading">Mall Address :</th>
							<td class="input">${malls.mall_address}</td>
						</tr>
						<tr>
							<th class="heading">Mall Phone :</th>
							<td class="input">${malls.mall_phone}</td>
						</tr>
						<tr>
							<th class="heading">Morning Time :</th>
							<td class="input">${malls.mall_amtiming}&nbsp;<span>AM</span></td>
						</tr>
						<tr>
							<th class="heading">Evening Time :</th>
							<td class="input">${malls.mall_pmtiming}&nbsp;<span>PM</span></td>
						</tr>
					</table>
