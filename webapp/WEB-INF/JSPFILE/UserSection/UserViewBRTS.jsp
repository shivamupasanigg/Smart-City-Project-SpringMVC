...
<!-- CSS File-->
<link rel="stylesheet"
	href="<c:url value='/resources/UserCSSFile/UserViewBRTS.css' />">
...
<!-- JQUERY File Link -->
<script
	src="<c:url value='/resources/UserJsFile/UserViewBRTSJs.js' />"></script>

<title>View BRTS Station</title>
</head>
<body>
	<!-- Load header -->
		...
		<div class="main box-show">
			...
			<div class="details">
				<div class="swiper mySwiper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${BRTSImageone}" alt="">
						</div>
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${BRTSImagetwo}" alt="">
						</div>
					</div>
				...
				<div class="details">
					<table>
						<tr>
							<th class="heading">BRTS Station Name :</th>
							<td class="input">${viewBrts.brts_Station_name}</td>
						</tr>
						<tr>
							<th class="heading">BRTS Station Address :</th>
							<td class="input">${viewBrts.brts_Station_address}</td>
						</tr>
					</table>
					
					<h1>BRTS Station Map</h1>
					<hr>
					<br>
