...
<!-- CSS File-->
<link rel="stylesheet"
	href="<c:url value='/resources/UserCSSFile/UserViewMostVisitedPlace.css' />">
...
<!-- JQUERY File Link -->
<script
	src="<c:url value='/resources/UserJsFile/UserViewMostVisitedPlaceJs.js' />"></script>

<title>View Most Visited place</title>
</head>
<body>
	<!-- Load header -->
	...
	<div class="Main">
		<div class="main box-show">
			<h1>Most Visited Place Images</h1>
			...
			<div class="details">
				<div class="swiper mySwiper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${PlaceImageone}" alt="">
						</div>
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${PlaceImagetwo}" alt="">
						</div>
					</div>
				...
				<div class="details">
					<table>
						<tr>
							<th class="heading">Place Name :</th>
							<td class="input">${ViewMostVisit.place_name}</td>
						</tr>
						<tr>
							<th class="heading">Place Address :</th>
							<td class="input">${ViewMostVisit.place_address}</td>
						</tr>
						<tr>
							<th class="heading">Place Phone :</th>
							<td class="input">${ViewMostVisit.place_phone}</td>
						</tr>
						<tr>
							<th class="heading">Morning Time :</th>
							<td class="input">${ViewMostVisit.place_amtiming}&nbsp;<span>AM</span></td>
						</tr>
						<tr>
							<th class="heading">Evening Time :</th>
							<td class="input">${ViewMostVisit.place_pmtiming}&nbsp;<span>PM</span></td>
						</tr>
					</table>
