...
<!-- CSS File-->
<link rel="stylesheet"
	href="<c:url value='/resources/UserCSSFile/UserViewMetro.css' />">
...
<!-- JQUERY File Link -->
<script
	src="<c:url value='/resources/UserJsFile/UserViewMetroJs.js' />"></script>

<title>View Metro</title>
</head>
<body>
<!-- Load header -->
		...
		<div class="main box-show">
			...
			<div class="details">
				<div class="swiper mySwiper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${MetroImageone}" alt="">
						</div>
						<div class="swiper-slide">
							<img src="data:image/jpeg;base64,${MetroImagetwo}" alt="">
						</div>
					</div>
				...
				<div class="details">
					<table>
						<tr>
							<th class="heading">Metro Station Name :</th>
							<td class="input">${ViewMetro.metro_Station_name}</td>
						</tr>
						<tr>
							<th class="heading">Metro Station Address :</th>
							<td class="input">${ViewMetro.metro_Station_address}</td>
						</tr>
					</table>
					
					<h1>Metro Station Map</h1>
					<hr>
					<br>
