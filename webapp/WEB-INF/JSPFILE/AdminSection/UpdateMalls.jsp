...
<script
	...
	<!-- JQUERY File Link -->
	<script src="<c:url value='/resources/AdminJsFile\UpdateMall.js' />"></script>
	<!--=============== CSS ===============-->
<link rel="stylesheet"
	href="<c:url value='/resources/AdminCSSFile/UpdateMalls.css' />">
...
<!-- Load header -->
     ...
     <div class="main">
		<form action="updatemall" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
			<div class="container">
				<h1>Update Malls</h1>
				<hr>
				<input type="hidden" name="id" id="id" value="${updatemalls.id}" autocomplete="off">
				<label for=""><b>Name of Mall <span class="validation">*</span></b></label> 
				<input type="text" placeholder="Enter Mall Name" name="mallname" id="mallname" value="${updatemalls.mall_name}" autocomplete="off">
				
				<br> 
				
				<label for=""><b>Mall Address <span class="validation">*</span></b></label>
				<textarea id="malladdress" name="malladdress" rows="3" cols="20" placeholder="Enter Mall Address">${updatemalls.mall_address}</textarea>
				
				<br> 
				
				<label for=""><b>Contact Number <span class="validation">*</span></b></label> 
				<br> 
				<input type="tel" placeholder="Enter Contact Number" name="mallcontact" id="mallcontact"  value="${updatemalls.mall_phone}" autocomplete="off"> 
				 
				<br> 
				
				<label for=""><b>Morning Time <span class="validation">*</span></b></label> 
				<br> 
				<input type="time" name="mallamTime" id="mallamTime" autocomplete="off" value="${updatemalls.mall_amtiming}"> 
				
				<br> 
				
				<label for=""><b>Evening Time <span class="validation">*</span></b></label> 
				<br> 
				<input type="time" name="mallpmTime" id="mallpmTime" autocomplete="off" value="${updatemalls.mall_pmtiming}"> 
				<br> 
				...
				<hr>
				<button type="submit" class="registerbtn">Update Malls</button>
			</div>
		</form>
	</div>
