...
<script
	...
	<!-- JQUERY File Link -->
	<script src="<c:url value='/resources/AdminJsFile/AddHospital.js' />"></script>
	<!--=============== CSS ===============-->
<link rel="stylesheet"
	href="<c:url value='/resources/AdminCSSFile/AddHospital.css' />">
...
<!-- Load header -->
     ...
     <div class="main">
        <form action="insertHospital" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        <div class="container">
            <h1>Add Hospital</h1>
            <hr>
            <label for=""><b>Name of Hospital <span class="validation">*</span></b></label>
            <input type="text" placeholder="Enter Hospital Name" name="hospitalname" id="hospitalname" autocomplete="off">
            <br>
            <label for=""><b>Hospital Address <span class="validation">*</span></b></label>
            <textarea id="hospitaladdress" name="hospitaladdress" rows="3" cols="20" placeholder="Enter Hospital Address"></textarea>
            <br>
            <label for=""><b>Hospital Facility <span class="validation">*</span></b></label>
            <textarea id="hospitalfacility" name="hospitalfacility" rows="3" cols="20" placeholder="Enter Hospital Facility"></textarea>
            <br>
            <label for=""><b>Contact number <span class="validation">*</span></b></label>
            <br>
            <input type="tel" placeholder="Enter Contact Number" name="hospitalcontact" id="hospitalcontact"  autocomplete="off">
            <br>
            <label for=""><b>Hospital  Timing <span class="validation">*</span></b></label>
            <br>
            <input type="text" placeholder="Enter Hospital Time" name="hospitaltime" id="hospitaltime" autocomplete="off">
            <br>
            ...
            <hr>
            <button type="submit" class="registerbtn">Add Hospital</button>
