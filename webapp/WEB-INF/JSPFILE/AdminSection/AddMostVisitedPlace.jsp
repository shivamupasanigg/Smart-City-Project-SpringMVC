...
<title>Add Most Visited Place</title>
<!-- Include jQuery -->
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
	
	<!-- JQUERY File Link -->
	<script src="<c:url value='/resources/AdminJsFile/AddMostVisitedPlace.js' />"></script>
	<!--=============== CSS ===============-->
<link rel="stylesheet"
	href="<c:url value='/resources/AdminCSSFile/AddMostVisitedPlace.css' />">
...
<!-- Load header -->
     ...
     <!-- Load Main Code -->
     <div class="main">
		<form action="save" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
			<div class="container">
				<h1>Add Most Visited Place</h1>
				<hr>
				<label for=""><b>Name of Place <span class="validation">*</span></b></label> 
				<input type="text" placeholder="Enter Place Name" name="placename" id="placename" autocomplete="off">
				
				<br> 
				
				<label for=""><b>Place Address <span class="validation">*</span></b></label>
				<textarea id="placeaddress" name="placeaddress" rows="3" cols="20" placeholder="Enter Place Address"></textarea>
				
				<br> 
				
				<label for=""><b>Contact Number <span class="validation">*</span></b></label> 
				<br> 
				<input type="tel" placeholder="Enter Contact Number" name="placecontact" id="placecontact" autocomplete="off"> 
				 
				<br> 
				
				<label for=""><b>Morning Time <span class="validation">*</span></b></label> 
				<br> 
				<input type="time" name="amTime" id="amTime" autocomplete="off"> 
				
				<br> 
				
				<label for=""><b>Evening Time <span class="validation">*</span></b></label> 
				<br> 
				<input type="time" name="pmTime" id="pmTime" autocomplete="off"> 
				<br> 
				...
				<hr>
				<button type="submit" class="registerbtn">Add Most Visited Place</button>
			</div>
		</form>
	</div>
