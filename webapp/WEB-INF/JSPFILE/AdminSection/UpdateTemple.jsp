...
<script
	...
	<!-- JQUERY File Link -->
	<script src="<c:url value='/resources/AdminJsFile/UpdateTemple.js' />"></script>
	<!--=============== CSS ===============-->
<link rel="stylesheet"
	href="<c:url value='/resources/AdminCSSFile/UpdateTemple.css' />">
...
<!-- Load header -->
     ...
     <div class="main">
        <form action="updateTemple" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        <div class="container">
            <h1>Update Temple</h1>
            <hr>
            <input type="hidden" name="id" id="id" value="${templelist.id}" autocomplete="off">
            <label for=""><b>Name of Temple <span class="validation">*</span></b></label>
            <input type="text" placeholder="Enter Temple Name" name="templename" id="templename" value="${templelist.temple_name}" autocomplete="off">
            <br>
            <label for=""><b>Temple Address <span class="validation">*</span></b></label>
            <textarea id="templeaddress" name="templeaddress" rows="3" cols="20" placeholder="Enter Temple address">${templelist.temple_address}</textarea>
            <br>
            <label for=""><b>Contact number <span class="validation">*</span></b></label>
            <br>
            <input type="tel" placeholder="Enter Contact Number" name="templecontact" id="templecontact" value="${templelist.temple_phone}" autocomplete="off">
            <br>
            <label for=""><b>Morning Time <span class="validation">*</span></b></label>
            <br>
            <input type="time" name="templeamtime" id="templeamtime" value="${templelist.temple_amtime}" autocomplete="off">
            <br>
            <label for=""><b>Evening Time <span class="validation">*</span></b></label>
            <br>
            <input type="time" name="templepmtime" id="templepmtime" value="${templelist.temple_pmtime}" autocomplete="off">
            <br>
            ...
            <hr>
            <button type="submit" class="registerbtn">Update Temple</button>
