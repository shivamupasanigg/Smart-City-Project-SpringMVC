...
<script
	...
	<!-- JQUERY File Link -->
	<script src="<c:url value='/resources/AdminJsFile/AddBRTS.js' />"></script>
	<!--=============== CSS ===============-->
<link rel="stylesheet"
	href="<c:url value='/resources/AdminCSSFile/AddBRTS.css' />">
<title>Add BRTS Stations</title>
<script>
	// validation js code
...
<!-- Load header -->
     ...
     <div class="main">
        <form action="insertBRTS" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        <div class="container">
            
            <h1>Add BRTS Stations</h1>
            <hr>
            <label for=""><b>BRTS Stations Name <span class="validation">*</span></b></label>
            <input type="text" placeholder="Enter BRTS Station Name" name="stationname" id="stationname" autocomplete="off">
            <br>
            <label for=""><b>BRTS Station Address <span class="validation">*</span></b></label>
            <textarea id="stationaddress" name="stationaddress" rows="3" cols="20" placeholder="BRTS Station Address"></textarea>
            <br>
            ...
            <br>
            <hr>
            <button type="submit" class="registerbtn">Add BRTS Stations</button>
